                    ...
                    <div class = "navbar-collapse collapse">
                        <ul class = "nav navbar-nav">
                            ...
                            <li><form action="cerca.php">
                                    <input type="text" placeholder="Cerca.." name="cerca" id="searchBar" maxlength="15">
                                        ...
                                        <div class = "row">
                                            <div class = "col-md-6 col-md-offset-6">
                                                <div class = "slide-content">
                                                    <h2>eEletronics</h2>
                                                    <p>Benvenuto nel sito di commercio elettronico realizzato da Michele, Stefano, e i due Matteo! Qui potrai comprare qualunque prodotto desideri, ma attenzione, il sito è ancora in fase Beta e alcune funzioni non sono ancora disponibili!</p>
                                                    <p>Il sito elettronico è pieno di funzionalità, e sarà molto semplice da utilizzare! Se hai bisogno di aiuto desideri comunicarci qualche problema riscontrato contattaci dall'apposito menù contatti!</p>
                                                    <a href="contatti.php" class="readmore">Vai ai contatti</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-6">
                                                <div class="slide-content">
                                                    <h2>Categorie</h2>
                                                    <p>Abbiamo lavorato molto a fondo e siamo riusciti a creare un negozio adatto a tutte le tue esigenze! Abbiamo organizzato i prodotti in più categorie, dall'elettronica alla cancelleria! Visita la pagina categorie per trovare più velocemente i prodotti!</p>
                                                    <a href="categorie.php" class="readmore">Vai alle categorie</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="slide-text">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-6">
                                                <div class="slide-content">
                                                    <h2>Non siamo solo programmatori</h2>
                                                    <p>Non siamo qui solamente per creare un semplice negozio online ma vogliamo offrire molto di più!</p>
                                                    <p>Il nostro sito offre numerosi accorgimenti che migliorano l'esperienza di ogni utente. Ha un design innovativo basato sul recente Material Design, e delle intelligentissime funzioni di gestione delle sessioni di ogni utente che memorizzano i vostri gusti per rendere il negozio sempre di vostro gradimento. Tramite la registrazione i vostri dati non verranno esplicitati a nessuno, ma tramite un metodo di crittografia end-to-end saranno sempre al sicuro! </p>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-about-us">
                            ...
                            <p>Benvenuto nel sito di commercio elettronico realizzato da Michele, Stefano, e i due Matteo!Qui potrai comprare qualunque prodotto desideri, ma attenzione, il sito è ancora in fase Beta e alcune funzioni non sono ancora disponibili! Il sito elettronico è pieno di funzionalità, e sarà molto semplice da utilizzare!Se hai bisogno di aiuto, o hai bisogno di comunicarci qualche problema riscontrato contattaci dall'apposito menù contatti!</p>
