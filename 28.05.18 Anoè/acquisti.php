<?php
session_start();
$_SESSION["paginaChiamante"] = "acquisti.php";
if (!$_SESSION["login"]) {
...
<html lang="en">
    ...
    <body>
		<?php echo "VISUALIZZA I TUOI ACQUISTI
dalla tabella STATO recuperare l'id del \"ACQUISTO\" e con quel valore di chiave
primaria selezionare tutte le righe della tabella ORDINE in cui idStato
corrisponde al valore della chiave primaria id della tabella STATO.
	\"    SELECT  S.nome, O.id, O.dataPagamento, O.dataPrevistaConsegna, O.idIndirizzoDestinatario, O.idPagamento, O.idStato --, O.idCliente, S.idStato, S.descrizione forse non servono tutti i campi se vuoi togli quelli che non ti servono
	       FROM  STATO S
	 INNER JOIN  ORDINE O
	         ON  S.id = O.idStato
	      WHERE  'ACQUISTO'=S.nome AND SidCliente=O.idCliente\"

DETTAGLI ACQUISTO
Dato un ordine ben specifico selezionare, come per il carrello, tutte le
righe della tabella PRODOTTIORDINATI in cui la chiave esterna idOrdine
corrisponde con la chiave primaria id della tabella ORDINE
	\"    SELECT  R.quantita, C.nome, P.nome, P.descrizione, P.dataInizio, P.dataFine, P.immagine, P.prezzoUnitario --,C.descrizione, P.quantitaTotale forse non servono tutti i campi se vuoi togli quelli che non ti servono
	 ...
	 INNER JOIN  PRODOTTIORDINATI R
	      ...
	      WHERE  SidOrdineDiAcquistoDaVisualizzare=R.idOrdine AND SidCliente=O.idCliente\""; ?>
                    ...
                    <div class = "navbar-collapse collapse">
                        <ul class = "nav navbar-nav">
							...
							if ($_SESSION["login"]) {
								...
								echo "<li class = \"active\"><a href = \"acquisti.php\">Acquisti</a></li>";
							} else {
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="product-bit-title text-center">
                            <h2>Procedere con l'acquisto</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            <div align="center" class="product-content-right">
                <div class="woocommerce">
                    <form align="center" enctype="multipart/form-data" action="#" class="checkout" method="post" name="checkout">
                        ...
                        <div id="payment">
                            <h3 id="payment_methods methods">Metodo di pagamento</h3>
