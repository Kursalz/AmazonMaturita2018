                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="product-inner">
                                        ...
                                        <h1 class="product-name"><?php echo $nomeProdotto; ?></h1>
										<div class="product-inner-price">
                                            <ins><h3><?php echo $prezzoUnitario; ?>&euro;</h3></ins> <!--<del>$800.00</del>-->
                                        </div>    
										<h4><?php echo "Disponibili: ", $quantitaTotale; ?></h4>
										<?php
										if ($_SESSION["login"]) {
											echo "<BUTTON class=\"button\"><A HREF=\"aggiungiAlCarrello.php\"> AGGIUNGI AL CARRELLO </A></BUTTON>";
										}
										?>
										<?php
