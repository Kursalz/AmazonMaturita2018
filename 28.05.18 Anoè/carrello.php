    ...
    <body>
        ...
        <table align=center border=1>
			...
			if (!isset($idOrdine)) {
				...
				while ($row = $statement->fetch()) {
					echo "<tr>";
					echo "<td style=' display: table-cell'><a href=\"prodotto.php?prodotto=", $row["id"], "\">";
					echo "<img height='200' width='200' src='", $row["immagine"], "'>";
					echo "</a></td>";
					echo "<td style=' display: table-cell'><a href=\"prodotto.php?prodotto=", $row["id"], "\">";
					echo "<div name='nomeProdotto'>", $row["nome"], "</div>"; //, ", disponibili: ", $row["quantitaTotale"];
					echo "</a></td>";
					echo "<td style=' display: table-cell'>", $row["quantita"], "</td>";
					echo "<td style=' display: table-cell'>", intval($row["prezzoUnitario"]) * intval($row["quantita"]), "&euro;</td>";
					echo "</tr>";
