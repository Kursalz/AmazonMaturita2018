                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="carrello.php"><i class="fa fa-user"></i> My Cart</a></li>
                            <li><a href="acquisto.php"><i class="fa fa-user"></i> Checkout</a></li>
                            <li><a href="registrati.php"><i class="fa fa-user"></i> Login</a></li>
                        </ul>
                    </div>
                </div>
             </div>
