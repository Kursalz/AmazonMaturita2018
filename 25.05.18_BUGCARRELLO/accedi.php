...
if ($_SESSION["login"] == false) {
    ...
    $statement = $db->prepare("SELECT * FROM CLIENTE WHERE :u=username") or die("Errore nella preparazione del database");
    ...
    $db = null;
    echo "<script type='text/javascript'>window.location.replace(\"", $_SESSION["paginaChiamante"], "\")</script>";
}
?>
