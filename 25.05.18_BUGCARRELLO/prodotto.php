...
<?php
session_start();
$_SESSION["paginaChiamante"] = "prodotto.php?prodotto=" . $_GET["prodotto"];
$_SESSION["idProdotto"] = $_GET["prodotto"];
$db = new PDO("sqlite:ECOMMERCE.sqlite");
if (!$db) {
    die("Errore nell'apertura del database");
}
$idProdotto = $_SESSION["idProdotto"];
$statement = $db->prepare("SELECT * FROM PRODOTTO P WHERE :p=P.id") or die("Errore nella preparazione del database");
$statement->bindParam(":p", $idProdotto, PDO::PARAM_STR);
$statement->execute();
$row = $statement->fetch();
...
$_SESSION["idCategoria"] = $row["idCategoria"];
                    ...
                    <div class="col-md-8">
                        <div class="product-content-right">
                            <div class="product-breadcroumb">
                                ...
                                <a href="categorie.php?categoria=<?php echo $idCategoria; ?>"><?php echo $nomeCategoria; ?></a>
                                <a href="prodotto.php?prodotto=<?php echo $idProdotto; ?>"><?php echo $nomeProdotto; ?></a>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="product-images">
                                        <div class="product-main-img">
                                            <img src="<?php echo $immagineProdotto; ?>" alt="">
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="product-inner">
                                        <?php
                                        if ($_SESSION["login"]) {
                                            echo "<A HREF=\"aggiungiAlCarrello.php\"><BUTTON> AGGIUNGI AL CARRELLO </BUTTON></A>";
                                        }
                                        ?>
                                        <h2 class="product-name"><?php echo $nomeProdotto; ?></h2>
                                        <div class="product-inner-price">
                                            <ins><?php echo $prezzoUnitario; ?>&euro;</ins> <!--<del>$800.00</del>-->
                                        </div>    
                                        ...
                                        <div class="product-inner-category">
                                            <p>Category: <a href="categorie.php?categoria=<?php echo $idCategoria; ?>"><?php echo $nomeCategoria; ?></a>.<!--Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>-->
                                        </div> 
                                        <div role="tabpanel">
