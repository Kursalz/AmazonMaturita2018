...
cambiare l'idStato dalla tabella acquisto (da carrello ad acquisto)";
        ...
        <table align=center border=1>
            <tr><td>Immagine Prodotto</td><td>Nome Prodotto</td><td>Quantità selezionata</td><td>Costo</td></tr>
            <?php
            $nomeStato = "CARRELLO";
            $db = new PDO("sqlite:ECOMMERCE.sqlite");
            if (!$db) {
            ...
            if (!isset($idOrdine)) {
                ...
                while ($row = $statement->fetch()) {
                    echo "<tr>";
                    echo "<td><a href=\"prodotto.php?prodotto=", $row["id"], "\">";
                    ...
                    echo "<td>", $row["prezzoUnitario"] * $row["quantita"], "&euro;</td>";
                    echo "</tr>";
                }
                $db = null;
            }
